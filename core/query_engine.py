...
class QueryEngine:
    ...
    def _project_result(self, result, result_type=None):
        """
        Project nested research records into typed semantic results.
        ...
        if result_type is None or result_type == base_type:
            return [result]
        ...
        if result_type == "decision":
            ...
            if research.get("next_goal"):
                projected.append({
                    "type": "goal",
                    "text": str(research["next_goal"]),
                    "data": common.copy(),
                    "score": result.get("score", 0),
                })
    ...
    def query(
        ...
        if result_type is not None:
            ...
            scored_results = projected_results
